...
var AuthInterceptorService = /** @class */ (function () {
    ...
    AuthInterceptorService.prototype.intercept = function (request, next) {
        return rxjs_1.from(this.handleAccess(request, next));
    };
        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, rxjs_1.lastValueFrom(this.auth.getAccessTokenSilently())];
                    case 2:
                        token = _a.sent();
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 4];
                    case 4: return [4 /*yield*/, rxjs_1.lastValueFrom(next.handle(request))];
